    ...
    public void onGetVideoFrame(boolean endOfStream) {
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                ByteBuffer videoEncodedData = encoderOutputBuffers[encoderStatus];
...
//                    if (!configFirstTime) return;
    ...
    public AudioRecord chooseAudioRecord() {
        ...
        AudioRecord mic = new AudioRecord(MediaRecorder.AudioSource.DEFAULT, VideoEncoderSimpleRtmp.ASAMPLERATE,
        ...
        if (mic.getState() != AudioRecord.STATE_INITIALIZED) {
            ...
            mic = new AudioRecord(MediaRecorder.AudioSource.DEFAULT, VideoEncoderSimpleRtmp.ASAMPLERATE,
