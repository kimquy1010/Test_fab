...
public class RecordFBOActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static class RenderThread extends Thread {
        ...
        private final Drawable2d mTriDrawable = new Drawable2d(Drawable2d.Prefab.RECTANGLE);
        ...
        public RenderThread(SurfaceHolder holder, ActivityHandler ahandler, File outputFile,
            ...
            Log.d(TAG, "Length of edges: " + mEdges.length);
        ...
        private void prepareGl(Surface surface) {
            ...
            Log.d(TAG, "Start create texture 2D");
        ...
        private void surfaceChanged(int width, int height) {
            ...
            Log.d(TAG, "mTri when surface change: " + mTri);
            Log.d(TAG, "mRect when surface change: " + mRect);
        }
        ...
        private void prepareFramebuffer(int width, int height) {
            Log.d(TAG, "Prepare Frame Buffer");
