...
// ---------------------------------------->
    ...
    private void setChunkSize() throws IOException
    {
        ...
        // Add header
        buffer.put(RtmpProtocol.generateType0Header(RtmpProtocol.CONTROL_MESSAGE_CHUNK_STREAM_ID, time.getCurrentTimestamp(),
                4, RtmpMessageType.SET_CHUNK_SIZE, RtmpProtocol.CONTROL_MESSAGE_STREAM_ID));
    ...
    private void sendAck(long bytesReceived) throws IOException
    {
        ...
        // Add header
        buffer.put(RtmpProtocol.generateType0Header(RtmpProtocol.CONTROL_MESSAGE_CHUNK_STREAM_ID, time.getCurrentTimestamp(),
                4, RtmpMessageType.ACK, RtmpProtocol.CONTROL_MESSAGE_STREAM_ID));
    ...
    private void sendPingResponse(long timestamp) throws IOException
    {
        ...
        // Add header
        buffer.put(RtmpProtocol.generateType0Header(RtmpProtocol.CONTROL_MESSAGE_CHUNK_STREAM_ID, time.getCurrentTimestamp(),
                6, RtmpMessageType.USER_CONTROL_MESSAGE, RtmpProtocol.CONTROL_MESSAGE_STREAM_ID));
...
//endregion
    ...
    public void createStream(@NonNull String playpath) throws IOException, NetworkOnMainThreadException, IllegalSelectorException
    {
        ...
        // Add header
        buffer.put(RtmpProtocol.generateType0Header(RtmpProtocol.CONTROL_MESSAGE_CHUNK_STREAM_ID, time.getCurrentTimestamp(),
                createStreamCommand.length, RtmpMessageType.COMMAND, RtmpProtocol.CONTROL_MESSAGE_STREAM_ID));
    ...
    public void deleteStream() throws IOException, NetworkOnMainThreadException, IllegalStateException
    {
        ...
        // Add header
        buffer.put(RtmpProtocol.generateType0Header(RtmpProtocol.CONTROL_MESSAGE_CHUNK_STREAM_ID, time.getCurrentTimestamp(),
                deleteStreamCommand.length, RtmpMessageType.COMMAND, RtmpProtocol.CONTROL_MESSAGE_STREAM_ID));
